...
class ClientAnalyticsQueryServiceTest {
    ...
    void getClientAnalytics_splitsNewAndReturningClients() {
        ...
        when(appointmentScope.findForClientAnalytics(eq(from), eq(to), isNull())).thenReturn(inRange);
        when(appointmentScope.findForClientAnalytics(eq(Instant.EPOCH), eq(from), isNull()))
    ...
    void shouldReturnZerosWhenNoAppointmentsInRange() {
        ...
        when(appointmentScope.findForClientAnalytics(eq(from), eq(to), isNull())).thenReturn(List.of());
        when(appointmentScope.findForClientAnalytics(eq(Instant.EPOCH), eq(from), isNull()))
                .thenReturn(List.of());
